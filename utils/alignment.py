...
from constants import DLIB_PREDICTOR_PATH
...
def align_face(input_image: np.ndarray, predictor) -> Optional[PIL.Image.Image]:
    """
    :param filepath: str
    :return: PIL Image
    """
    lm = get_landmark(input_image, predictor)
